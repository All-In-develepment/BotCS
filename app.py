...
from Games import getAllGames, filterNextGames, getMapsBO1, getMapsBO3, getMatchInfo, strutuctInfo
        ...
        if( all_games != "Erro ao conectar com a API" or all_games['statusCode'] != 500):
            ...
            for match in match_info:
                ...
                if(str(new_structure['has_map']) == "True"):
                    ...
                    # se não houver faz a busca necessário
                    if not tip_is_open:
                        ...
                        # Formatação de data de forma legivel
                        ...
                        if (favorite_team == 'T1'):
                            ...
                            CreateTips(
                                match['id'], 
                                True, 
                                date_timestemp.strftime('%d/%m/%Y %H:%M'), 
                                match['team1']['name'],
                                match['team2']['name'],
                                informacoes['firt_map_element'],
                                informacoes['second_map_element'],
                                informacoes['third_map_element'],
                                'N/A',
                                'N/A',
                                first_map_tip,
                                second_map_tip,
